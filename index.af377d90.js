 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(t,e=!0){pc="9.22.0",Ot(new X("firestore",((t,{instanceIdentifier:n,options:r})=>{const i=t.getProvider("app").getImmediate(),s=new vg(new Nc(t.getProvider("auth-internal")),new Pc(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new Sc(_c.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ru(t.options.projectId,e)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s}),"PUBLIC").setMultipleInstances(!0)),Ut("@firebase/firestore","3.12.0",t),Ut("@firebase/firestore","3.12.0","esm2017")}();const bm=xt({apiKey:"AIzaSyAYO4Ie3dyg57FYXwv2s34tOoBXm3UaMzg",authDomain:"users-bookshelf.firebaseapp.com",projectId:"users-bookshelf",storageBucket:"users-bookshelf.appspot.com",messagingSenderId:"1093946480659",appId:"1:1093946480659:web:6fdb7ef580bf859789c7e6"}),Em=function(t=Mt()){const e=Dt(t,"auth");if(e.isInitialized())return e.getImmediate();const n=function(t,e){const n=Dt(t,"auth");if(n.isInitialized()){const t=n.getImmediate();if($(n.getOptions(),null!=e?e:{}))return t;Zt(t,"already-initialized")}return n.initialize({options:e})}(t,{popupRedirectResolver:Fr,persistence:[er,jn,qn]}),r=O("authTokenSyncURL");if(r){const t=(i=r,async t=>{const e=t&&await t.getIdTokenResult(),n=e&&((new Date).getTime()-Date.parse(e.issuedAtTime))/1e3;if(n&&n>Vr)return;const r=null==e?void 0:e.token;jr!==r&&(jr=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(t,e,n){J(t).beforeAuthStateChanged(e,n)}(n,t,(()=>t(n.currentUser))),function(t,e,n,r){J(t).onIdTokenChanged(e,n,r)}(n,(e=>t(e)))}var i;const s=k("auth");return s&&cn(n,`http://${s}`),n}(),Im=function(t,e){const n="string"==typeof t?t:e||"(default)",r=Dt("object"==typeof t?t:Mt(),"firestore").getImmediate({identifier:n});if(!r._initialized){const t=R("firestore");t&&hg(r,...t)}return r}(bm);var Tm=!1;let _m="";var Sm,Cm,Am;Sm=t=>{t&&(t.uid,Tm=!0,_m=t.uid),localStorage.setItem("IS_CUSTOMER_LOGGED_IN",Tm)},J(Em).onAuthStateChanged(Sm,Cm,Am);const km=document.querySelector(".signin-cont"),Rm=document.querySelector(".signup-cont"),Nm=document.querySelector(".signup"),Om=document.querySelector(".signin"),Dm=document.querySelector(".js-signup-btn"),Lm=document.querySelector(".content"),Pm=document.querySelector(".tabs");Dm.addEventListener("click",(()=>{Lm.hidden})),Pm.addEventListener("click",(function(t){Om.classList.toggle("active"),Nm.classList.toggle("active"),km.classList.toggle("hidden"),Rm.classList.toggle("hidden")}));document.querySelector(".js-form-signup").addEventListener("submit",(function(t){t.preventDefault();const{name:e,email:n,password:r}=t.currentTarget.elements;Mn(Em,n.value,r.value).then((t=>{const r=t.user;mm(mg(Im,"customers",n.value),{customer_name:e.value,customer_email:n.value,shopping_list:"",customer_avatar:"",session_id:r.uid}),window.open("/")})).catch((t=>{t.code;const e=t.message;alert(e)}))}));document.querySelector(".js-form-signin").addEventListener("submit",(function(t){t.preventDefault();const{email:e,password:n}=t.currentTarget.elements;Un(Em,e.value,n.value).then((async t=>{const n=t.user,r=mg(Im,"customers",e.value);await ym(r,{session_id:n.uid});const i=await fm(r);i.exists()&&(console.log("Document data (Shoping list):",i.data().shopping_list),localStorage.setItem("bookId",i.data().shopping_list)),window.open("/")})).catch((t=>{t.code;const e=t.message;alert(e)}))}));document.querySelector(".js-signout").addEventListener("click",(function(){Fn(Em).then((async()=>{if(""==_m)return!0;const t=Yg(gg(Im,"customers"),tm("session_id","==",_m)),e=await gm(t);let n="";if(e.forEach((t=>{n=t.data().customer_email})),n){const t=mg(Im,"customers",n);await ym(t,{shopping_list:localStorage.getItem("bookId")})}localStorage.removeItem("bookId"),window.open("/")})).catch((t=>{}))}));const xm=document.querySelector(".burger-menu-icon"),Mm=document.querySelector(".burger-menu");xm.addEventListener("click",(function(){Mm.innerHTML='<div class="burger-conteiner">\n            <button class="button_user btn-user-burger">\n                <div class="avatar">\n                    <img class="avatar_img" src="../images/face.jpeg" alt="">\n                </div>\n                Stephen\n            </button>\n            <nav class="navigation navigation-burger">\n                <ul class="navigation-burger-list">\n                    <li class="navigation-item navigation-burger-item"><a class="navigation-link" href="#">Home</a></li>\n                    <li class="navigation-item navigation-burger-item"><a class="navigation-link" href="#">Shopping List</a></li>\n                </ul>\n            </nav>\n            <button class="button_logout btn-logout-burger">Log out\n                <svg width="20" height="20">\n                    <use href="../images/icons.svg#icon-arrow-narrow-right"></use>\n                </svg>\n          </button>\n        </div>'}));const Um=document.querySelector("body"),Fm=document.querySelector("#theme-switch-toggle");Fm.addEventListener("change",(t=>{Um.classList.contains("dark")?(Um.classList.remove("dark"),localStorage.removeItem("darkTheme")):(Um.classList.add("dark"),localStorage.setItem("darkTheme","true"))}));localStorage.getItem("darkTheme");function Bm(t,e){return function(){return t.apply(e,arguments)}}localStorage.getItem("darkTheme")&&(Um.classList.add("dark"),Fm.checked=!0);const{toString:Vm}=Object.prototype,{getPrototypeOf:jm}=Object,$m=(qm=Object.create(null),t=>{const e=Vm.call(t);return qm[e]||(qm[e]=e.slice(8,-1).toLowerCase())});var qm;const zm=t=>(t=t.toLowerCase(),e=>$m(e)===t),Hm=t=>e=>typeof e===t,{isArray:Km}=Array,Gm=Hm("undefined");const Wm=zm("ArrayBuffer");const Qm=Hm("string"),Jm=Hm("function"),Xm=Hm("number"),Ym=t=>null!==t&&"object"==typeof t,Zm=t=>{if("object"!==$m(t))return!1;const e=jm(t);return!(null!==e&&e!==Object.prototype&&null!==Object.getPrototypeOf(e)||Symbol.toStringTag in t||Symbol.iterator in t)},ty=zm("Date"),ey=zm("File"),ny=zm("Blob"),ry=zm("FileList"),iy=zm("URLSearchParams");function sy(t,e,{allOwnKeys:n=!1}={}){if(null==t)return;let r,i;if("object"!=typeof t&&(t=[t]),Km(t))for(r=0,i=t.length;r<i;r++)e.call(null,t[r],r,t);else{const i=n?Object.getOwnPropertyNames(t):Object.keys(t),s=i.length;let o;for(r=0;r<s;r++)o=i[r],e.call(null,t[o],o,t)}}function oy(t,e){e=e.toLowerCase();const n=Object.keys(t);let r,i=n.length;for(;i-- >0;)if(r=n[i],e===r.toLowerCase())return r;return null}const ay="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:e,cy=t=>!Gm(t)&&t!==ay;const uy=(ly="undefined"!=typeof Uint8Array&&jm(Uint8Array),t=>ly&&t instanceof ly);var ly;const hy=zm("HTMLFormElement"),dy=(({hasOwnProperty:t})=>(e,n)=>t.call(e,n))(Object.prototype),fy=zm("RegExp"),py=(t,e)=>{const n=Object.getOwnPropertyDescriptors(t),r={};sy(n,((n,i)=>{!1!==e(n,i,t)&&(r[i]=n)})),Object.defineProperties(t,r)},gy={DIGIT:"0123456789",ALPHA:"abcdefghijklmnopqrstuvwxyz",ALPHA_DIGIT:"abcdefghijklmnopqrstuvwxyz"+"abcdefghijklmnopqrstuvwxyz".toUpperCase()+"0123456789"};const my=zm("AsyncFunction");var yy={isArray:Km,isArrayBuffer:Wm,isBuffer:function(t){return null!==t&&!Gm(t)&&null!==t.constructor&&!Gm(t.constructor)&&Jm(t.constructor.isBuffer)&&t.constructor.isBuffer(t)},isFormData:t=>{let e;return t&&("function"==typeof FormData&&t instanceof FormData||Jm(t.append)&&("formdata"===(e=$m(t))||"object"===e&&Jm(t.toString)&&"[object FormData]"===t.toString()))},isArrayBufferView:function(t){let e;return e="undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&Wm(t.buffer),e},isString:Qm,isNumber:Xm,isBoolean:t=>!0===t||!1===t,isObject:Ym,isPlainObject:Zm,isUndefined:Gm,isDate:ty,isFile:ey,isBlob:ny,isRegExp:fy,isFunction:Jm,isStream:t=>Ym(t)&&Jm(t.pipe),isURLSearchParams:iy,isTypedArray:uy,isFileList:ry,forEach:sy,merge:function t(){const{caseless:e}=cy(this)&&this||{},n={},r=(r,i)=>{const s=e&&oy(n,i)||i;Zm(n[s])&&Zm(r)?n[s]=t(n[s],r):Zm(r)?n[s]=t({},r):Km(r)?n[s]=r.slice():n[s]=r};for(let t=0,e=arguments.length;t<e;t++)arguments[t]&&sy(arguments[t],r);return n},extend:(t,e,n,{allOwnKeys:r}={})=>(sy(e,((e,r)=>{n&&Jm(e)?t[r]=Bm(e,n):t[r]=e}),{allOwnKeys:r}),t),trim:t=>t.trim?t.trim():t.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,""),stripBOM:t=>(65279===t.charCodeAt(0)&&(t=t.slice(1)),t),inherits:(t,e,n,r)=>{t.prototype=Object.create(e.prototype,r),t.prototype.constructor=t,Object.defineProperty(t,"super",{value:e.prototype}),n&&Object.assign(t.prototype,n)},toFlatObject:(t,e,n,r)=>{let i,s,o;const a={};if(e=e||{},null==t)return e;do{for(i=Object.getOwnPropertyNames(t),s=i.length;s-- >0;)o=i[s],r&&!r(o,t,e)||a[o]||(e[o]=t[o],a[o]=!0);t=!1!==n&&jm(t)}while(t&&(!n||n(t,e))&&t!==Object.prototype);return e},kindOf:$m,kindOfTest:zm,endsWith:(t,e,n)=>{t=String(t),(void 0===n||n>t.length)&&(n=t.length),n-=e.length;const r=t.indexOf(e,n);return-1!==r&&r===n},toArray:t=>{if(!t)return null;if(Km(t))return t;let e=t.length;if(!Xm(e))return null;const n=new Array(e);for(;e-- >0;)n[e]=t[e];return n},forEachEntry:(t,e)=>{const n=(t&&t[Symbol.iterator]).call(t);let r;for(;(r=n.next())&&!r.done;){const n=r.value;e.call(t,n[0],n[1])}},matchAll:(t,e)=>{let n;const r=[];for(;null!==(n=t.exec(e));)r.push(n);return r},isHTMLForm:hy,hasOwnProperty:dy,hasOwnProp:dy,reduceDescriptors:py,freezeMethods:t=>{py(t,((e,n)=>{if(Jm(t)&&-1!==["arguments","caller","callee"].indexOf(n))return!1;const r=t[n];Jm(r)&&(e.enumerable=!1,"writable"in e?e.writable=!1:e.set||(e.set=()=>{throw Error("Can not rewrite read-only method '"+n+"'")}))}))},toObjectSet:(t,e)=>{const n={},r=t=>{t.forEach((t=>{n[t]=!0}))};return Km(t)?r(t):r(String(t).split(e)),n},toCamelCase:t=>t.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,(function(t,e,n){return e.toUpperCase()+n})),noop:()=>{},toFiniteNumber:(t,e)=>(t=+t,Number.isFinite(t)?t:e),findKey:oy,global:ay,isContextDefined:cy,ALPHABET:gy,generateString:(t=16,e=gy.ALPHA_DIGIT)=>{let n="";const{length:r}=e;for(;t--;)n+=e[Math.random()*r|0];return n},isSpecCompliantForm:function(t){return!!(t&&Jm(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{const e=new Array(10),n=(t,r)=>{if(Ym(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[r]=t;const i=Km(t)?[]:{};return sy(t,((t,e)=>{const s=n(t,r+1);!Gm(s)&&(i[e]=s)})),e[r]=void 0,i}}return t};return n(t,0)},isAsyncFn:my,isThenable:t=>t&&(Ym(t)||Jm(t))&&Jm(t.then)&&Jm(t.catch)};function vy(t,e,n,r,i){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=(new Error).stack,this.message=t,this.name="AxiosError",e&&(this.code=e),n&&(this.config=n),r&&(this.request=r),i&&(this.response=i)}yy.inherits(vy,Error,{toJSON:function(){return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:yy.toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});const wy=vy.prototype,by={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach((t=>{by[t]={value:t}})),Object.defineProperties(vy,by),Object.defineProperty(wy,"isAxiosError",{value:!0}),vy.from=(t,e,n,r,i,s)=>{const o=Object.create(wy);return yy.toFlatObject(t,o,(function(t){return t!==Error.prototype}),(t=>"isAxiosError"!==t)),vy.call(o,t.message,e,n,r,i),o.cause=t,o.name=t.name,s&&Object.assign(o,s),o};var Ey,Iy,Ty,_y=vy;Iy=function(t){var e,n,r=Ly(t),i=r[0],s=r[1],o=new Ry(function(t,e,n){return 3*(e+n)/4-n}(0,i,s)),a=0,c=s>0?i-4:i;for(n=0;n<c;n+=4)e=ky[t.charCodeAt(n)]<<18|ky[t.charCodeAt(n+1)]<<12|ky[t.charCodeAt(n+2)]<<6|ky[t.charCodeAt(n+3)],o[a++]=e>>16&255,o[a++]=e>>8&255,o[a++]=255&e;2===s&&(e=ky[t.charCodeAt(n)]<<2|ky[t.charCodeAt(n+1)]>>4,o[a++]=255&e);1===s&&(e=ky[t.charCodeAt(n)]<<10|ky[t.charCodeAt(n+1)]<<4|ky[t.charCodeAt(n+2)]>>2,o[a++]=e>>8&255,o[a++]=255&e);return o},Ty=function(t){for(var e,n=t.length,r=n%3,i=[],s=16383,o=0,a=n-r;o<a;o+=s)i.push(Py(t,o,o+s>a?a:o+s));1===r?(e=t[n-1],i.push(Ay[e>>2]+Ay[e<<4&63]+"==")):2===r&&(e=(t[n-2]<<8)+t[n-1],i.push(Ay[e>>10]+Ay[e>>4&63]+Ay[e<<2&63]+"="));return i.join("")}
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */;for(var Sy,Cy,Ay=[],ky=[],Ry="undefined"!=typeof Uint8Array?Uint8Array:Array,Ny="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",Oy=0,Dy=Ny.length;Oy<Dy;++Oy)Ay[Oy]=Ny[Oy],ky[Ny.charCodeAt(Oy)]=Oy;function Ly(t){var e=t.length;if(e%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var n=t.indexOf("=");return-1===n&&(n=e),[n,n===e?0:4-n%4]}function Py(t,e,n){for(var r,i,s=[],o=e;o<n;o+=3)r=(t[o]<<16&16711680)+(t[o+1]<<8&65280)+(255&t[o+2]),s.push(Ay[(i=r)>>18&63]+Ay[i>>12&63]+Ay[i>>6&63]+Ay[63&i]);return s.join("")}ky["-".charCodeAt(0)]=62,ky["_".charCodeAt(0)]=63,Sy=function(t,e,n,r,i){var s,o,a=8*i-r-1,c=(1<<a)-1,u=c>>1,l=-7,h=n?i-1:0,d=n?-1:1,f=t[e+h];for(h+=d,s=f&(1<<-l)-1,f>>=-l,l+=a;l>0;s=256*s+t[e+h],h+=d,l-=8);for(o=s&(1<<-l)-1,s>>=-l,l+=r;l>0;o=256*o+t[e+h],h+=d,l-=8);if(0===s)s=1-u;else{if(s===c)return o?NaN:1/0*(f?-1:1);o+=Math.pow(2,r),s-=u}return(f?-1:1)*o*Math.pow(2,s-r)},Cy=function(t,e,n,r,i,s){var o,a,c,u=8*s-i-1,l=(1<<u)-1,h=l>>1,d=23===i?Math.pow(2,-24)-Math.pow(2,-77):0,f=r?0:s-1,p=r?1:-1,g=e<0||0===e&&1/e<0?1:0;for(e=Math.abs(e),isNaN(e)||e===1/0?(a=isNaN(e)?1:0,o=l):(o=Math.floor(Math.log(e)/Math.LN2),e*(c=Math.pow(2,-o))<1&&(o--,c*=2),(e+=o+h>=1?d/c:d*Math.pow(2,1-h))*c>=2&&(o++,c/=2),o+h>=l?(a=0,o=l):o+h>=1?(a=(e*c-1)*Math.pow(2,i),o+=h):(a=e*Math.pow(2,h-1)*Math.pow(2,i),o=0));i>=8;t[n+f]=255&a,f+=p,a/=256,i-=8);for(o=o<<i|a,u+=i;u>0;t[n+f]=255&o,f+=p,o/=256,u-=8);t[n+f-p]|=128*g};const xy="function"==typeof Symbol&&"function"==typeof Symbol.for?Symbol.for("nodejs.util.inspect.custom"):null;Ey=Uy;function My(t){if(t>2147483647)throw new RangeError('The value "'+t+'" is invalid for option "size"');const e=new Uint8Array(t);return Object.setPrototypeOf(e,Uy.prototype),e}function Uy(t,e,n){if("number"==typeof t){if("string"==typeof e)throw new TypeError('The "string" argument must be of type string. Received type number');return Vy(t)}return Fy(t,e,n)}function Fy(t,e,n){if("string"==typeof t)return function(t,e){"string"==typeof e&&""!==e||(e="utf8");if(!Uy.isEncoding(e))throw new TypeError("Unknown encoding: "+e);const n=0|zy(t,e);let r=My(n);const i=r.write(t,e);i!==n&&(r=r.slice(0,i));return r}(t,e);if(ArrayBuffer.isView(t))return function(t){if(Tv(t,Uint8Array)){const e=new Uint8Array(t);return $y(e.buffer,e.byteOffset,e.byteLength)}return jy(t)}(t);if(null==t)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof t);if(Tv(t,ArrayBuffer)||t&&Tv(t.buffer,ArrayBuffer))return $y(t,e,n);if("undefined"!=typeof SharedArrayBuffer&&(Tv(t,SharedArrayBuffer)||t&&Tv(t.buffer,SharedArrayBuffer)))return $y(t,e,n);if("number"==typeof t)throw new TypeError('The "value" argument must not be of type number. Received type number');const r=t.valueOf&&t.valueOf();if(null!=r&&r!==t)return Uy.from(r,e,n);const i=function(t){if(Uy.isBuffer(t)){const e=0|qy(t.length),n=My(e);return 0===n.length||t.copy(n,0,0,e),n}if(void 0!==t.length)return"number"!=typeof t.length||_v(t.length)?My(0):jy(t);if("Buffer"===t.type&&Array.isArray(t.data))return jy(t.data)}(t);if(i)return i;if("undefined"!=typeof Symbol&&null!=Symbol.toPrimitive&&"function"==typeof t[Symbol.toPrimitive])return Uy.from(t[Symbol.toPrimitive]("string"),e,n);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof t)}function By(t){if("number"!=typeof t)throw new TypeError('"size" argument must be of type number');if(t<0)throw new RangeError('The value "'+t+'" is invalid for option "size"')}function Vy(t){return By(t),My(t<0?0:0|qy(t))}function jy(t){const e=t.length<0?0:0|qy(t.length),n=My(e);for(let r=0;r<e;r+=1)n[r]=255&t[r];return n}function $y(t,e,n){if(e<0||t.byteLength<e)throw new RangeError('"offset" is outside of buffer bounds');if(t.byteLength<e+(n||0))throw new RangeError('"length" is outside of buffer bounds');let r;return r=void 0===e&&void 0===n?new Uint8Array(t):void 0===n?new Uint8Array(t,e):new Uint8Array(t,e,n),Object.setPrototypeOf(r,Uy.prototype),r}function qy(t){if(t>=2147483647)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+2147483647..toString(16)+" bytes");return 0|t}function zy(t,e){if(Uy.isBuffer(t))return t.length;if(ArrayBuffer.isView(t)||Tv(t,ArrayBuffer))return t.byteLength;if("string"!=typeof t)throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof t);const n=t.length,r=arguments.length>2&&!0===arguments[2];if(!r&&0===n)return 0;let i=!1;for(;;)switch(e){case"ascii":case"latin1":case"binary":return n;case"utf8":case"utf-8":return bv(t).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*n;case"hex":return n>>>1;case"base64":return Ev(t).length;default:if(i)return r?-1:bv(t).length;e=(""+e).toLowerCase(),i=!0}}function Hy(t,e,n){let r=!1;if((void 0===e||e<0)&&(e=0),e>this.length)return"";if((void 0===n||n>this.length)&&(n=this.length),n<=0)return"";if((n>>>=0)<=(e>>>=0))return"";for(t||(t="utf8");;)switch(t){case"hex":return iv(this,e,n);case"utf8":case"utf-8":return ev(this,e,n);case"ascii":return nv(this,e,n);case"latin1":case"binary":return rv(this,e,n);case"base64":return tv(this,e,n);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return sv(this,e,n);default:if(r)throw new TypeError("Unknown encoding: "+t);t=(t+"").toLowerCase(),r=!0}}function Ky(t,e,n){const r=t[e];t[e]=t[n],t[n]=r}function Gy(t,e,n,r,i){if(0===t.length)return-1;if("string"==typeof n?(r=n,n=0):n>2147483647?n=2147483647:n<-2147483648&&(n=-2147483648),_v(n=+n)&&(n=i?0:t.length-1),n<0&&(n=t.length+n),n>=t.length){if(i)return-1;n=t.length-1}else if(n<0){if(!i)return-1;n=0}if("string"==typeof e&&(e=Uy.from(e,r)),Uy.isBuffer(e))return 0===e.length?-1:Wy(t,e,n,r,i);if("number"==typeof e)return e&=255,"function"==typeof Uint8Array.prototype.indexOf?i?Uint8Array.prototype.indexOf.call(t,e,n):Uint8Array.prototype.lastIndexOf.call(t,e,n):Wy(t,[e],n,r,i);throw new TypeError("val must be string, number or Buffer")}function Wy(t,e,n,r,i){let s,o=1,a=t.length,c=e.length;if(void 0!==r&&("ucs2"===(r=String(r).toLowerCase())||"ucs-2"===r||"utf16le"===r||"utf-16le"===r)){if(t.length<2||e.length<2)return-1;o=2,a/=2,c/=2,n/=2}function u(t,e){return 1===o?t[e]:t.readUInt16BE(e*o)}if(i){let r=-1;for(s=n;s<a;s++)if(u(t,s)===u(e,-1===r?0:s-r)){if(-1===r&&(r=s),s-r+1===c)return r*o}else-1!==r&&(s-=s-r),r=-1}else for(n+c>a&&(n=a-c),s=n;s>=0;s--){let n=!0;for(let r=0;r<c;r++)if(u(t,s+r)!==u(e,r)){n=!1;break}if(n)return s}return-1}function Qy(t,e,n,r){n=Number(n)||0;const i=t.length-n;r?(r=Number(r))>i&&(r=i):r=i;const s=e.length;let o;for(r>s/2&&(r=s/2),o=0;o<r;++o){const r=parseInt(e.substr(2*o,2),16);if(_v(r))return o;t[n+o]=r}return o}function Jy(t,e,n,r){return Iv(bv(e,t.length-n),t,n,r)}function Xy(t,e,n,r){return Iv(function(t){const e=[];for(let n=0;n<t.length;++n)e.push(255&t.charCodeAt(n));return e}(e),t,n,r)}function Yy(t,e,n,r){return Iv(Ev(e),t,n,r)}function Zy(t,e,n,r){return Iv(function(t,e){let n,r,i;const s=[];for(let o=0;o<t.length&&!((e-=2)<0);++o)n=t.charCodeAt(o),r=n>>8,i=n%256,s.push(i),s.push(r);return s}(e,t.length-n),t,n,r)}function tv(t,e,n){return 0===e&&n===t.length?Ty(t):Ty(t.slice(e,n))}function ev(t,e,n){n=Math.min(t.length,n);const r=[];let i=e;for(;i<n;){const e=t[i];let s=null,o=e>239?4:e>223?3:e>191?2:1;if(i+o<=n){let n,r,a,c;switch(o){case 1:e<128&&(s=e);break;case 2:n=t[i+1],128==(192&n)&&(c=(31&e)<<6|63&n,c>127&&(s=c));break;case 3:n=t[i+1],r=t[i+2],128==(192&n)&&128==(192&r)&&(c=(15&e)<<12|(63&n)<<6|63&r,c>2047&&(c<55296||c>57343)&&(s=c));break;case 4:n=t[i+1],r=t[i+2],a=t[i+3],128==(192&n)&&128==(192&r)&&128==(192&a)&&(c=(15&e)<<18|(63&n)<<12|(63&r)<<6|63&a,c>65535&&c<1114112&&(s=c))}}null===s?(s=65533,o=1):s>65535&&(s-=65536,r.push(s>>>10&1023|55296),s=56320|1023&s),r.push(s),i+=o}return function(t){const e=t.length;if(e<=4096)return String.fromCharCode.apply(String,t);let n="",r=0;for(;r<e;)n+=String.fromCharCode.apply(String,t.slice(r,r+=4096));return n}(r)}Uy.TYPED_ARRAY_SUPPORT=function(){try{const t=new Uint8Array(1),e={foo:function(){return 42}};return Object.setPrototypeOf(e,Uint8Array.prototype),Object.setPrototypeOf(t,e),42===t.foo()}catch(t){return!1}}(),Uy.TYPED_ARRAY_SUPPORT||"undefined"==typeof console||"function"!=typeof console.error||console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support."),Object.defineProperty(Uy.prototype,"parent",{enumerable:!0,get:function(){if(Uy.isBuffer(this))return this.buffer}}),Object.defineProperty(Uy.prototype,"offset",{enumerable:!0,get:function(){if(Uy.isBuffer(this))return this.byteOffset}}),Uy.poolSize=8192,Uy.from=function(t,e,n){return Fy(t,e,n)},Object.setPrototypeOf(Uy.prototype,Uint8Array.prototype),Object.setPrototypeOf(Uy,Uint8Array),Uy.alloc=function(t,e,n){return function(t,e,n){return By(t),t<=0?My(t):void 0!==e?"string"==typeof n?My(t).fill(e,n):My(t).fill(e):My(t)}(t,e,n)},Uy.allocUnsafe=function(t){return Vy(t)},Uy.allocUnsafeSlow=function(t){return Vy(t)},Uy.isBuffer=function(t){return null!=t&&!0===t._isBuffer&&t!==Uy.prototype},Uy.compare=function(t,e){if(Tv(t,Uint8Array)&&(t=Uy.from(t,t.offset,t.byteLength)),Tv(e,Uint8Array)&&(e=Uy.from(e,e.offset,e.byteLength)),!Uy.isBuffer(t)||!Uy.isBuffer(e))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(t===e)return 0;let n=t.length,r=e.length;for(let i=0,s=Math.min(n,r);i<s;++i)if(t[i]!==e[i]){n=t[i],r=e[i];break}return n<r?-1:r<n?1:0},Uy.isEncoding=function(t){switch(String(t).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},Uy.concat=function(t,e){if(!Array.isArray(t))throw new TypeError('"list" argument must be an Array of Buffers');if(0===t.length)return Uy.alloc(0);let n;if(void 0===e)for(e=0,n=0;n<t.length;++n)e+=t[n].length;const r=Uy.allocUnsafe(e);let i=0;for(n=0;n<t.length;++n){let e=t[n];if(Tv(e,Uint8Array))i+e.length>r.length?(Uy.isBuffer(e)||(e=Uy.from(e)),e.copy(r,i)):Uint8Array.prototype.set.call(r,e,i);else{if(!Uy.isBuffer(e))throw new TypeError('"list" argument must be an Array of Buffers');e.copy(r,i)}i+=e.length}return r},Uy.byteLength=zy,Uy.prototype._isBuffer=!0,Uy.prototype.swap16=function(){const t=this.length;if(t%2!=0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(let e=0;e<t;e+=2)Ky(this,e,e+1);return this},Uy.prototype.swap32=function(){const t=this.length;if(t%4!=0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(let e=0;e<t;e+=4)Ky(this,e,e+3),Ky(this,e+1,e+2);return this},Uy.prototype.swap64=function(){const t=this.length;if(t%8!=0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(let e=0;e<t;e+=8)Ky(this,e,e+7),Ky(this,e+1,e+6),Ky(this,e+2,e+5),Ky(this,e+3,e+4);return this},Uy.prototype.toString=function(){const t=this.length;return 0===t?"":0===arguments.length?ev(this,0,t):Hy.apply(this,arguments)},Uy.prototype.toLocaleString=Uy.prototype.toString,Uy.prototype.equals=function(t){if(!Uy.isBuffer(t))throw new TypeError("Argument must be a Buffer");return this===t||0===Uy.compare(this,t)},Uy.prototype.inspect=function(){let t="";return t=this.toString("hex",0,50).replace(/(.{2})/g,"$1 ").trim(),this.length>50&&(t+=" ... "),"<Buffer "+t+">"},xy&&(Uy.prototype[xy]=Uy.prototype.inspect),Uy.prototype.compare=function(t,e,n,r,i){if(Tv(t,Uint8Array)&&(t=Uy.from(t,t.offset,t.byteLength)),!Uy.isBuffer(t))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof t);if(void 0===e&&(e=0),void 0===n&&(n=t?t.length:0),void 0===r&&(r=0),void 0===i&&(i=this.length),e<0||n>t.length||r<0||i>this.length)throw new RangeError("out of range index");if(r>=i&&e>=n)return 0;if(r>=i)return-1;if(e>=n)return 1;if(this===t)return 0;let s=(i>>>=0)-(r>>>=0),o=(n>>>=0)-(e>>>=0);const a=Math.min(s,o),c=this.slice(r,i),u=t.slice(e,n);for(let t=0;t<a;++t)if(c[t]!==u[t]){s=c[t],o=u[t];break}return s<o?-1:o<s?1:0},Uy.prototype.includes=function(t,e,n){return-1!==this.indexOf(t,e,n)},Uy.prototype.indexOf=function(t,e,n){return Gy(this,t,e,n,!0)},Uy.prototype.lastIndexOf=function(t,e,n){return Gy(this,t,e,n,!1)},Uy.prototype.write=function(t,e,n,r){if(void 0===e)r="utf8",n=this.length,e=0;else if(void 0===n&&"string"==typeof e)r=e,n=this.length,e=0;else{if(!isFinite(e))throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");e>>>=0,isFinite(n)?(n>>>=0,void 0===r&&(r="utf8")):(r=n,n=void 0)}const i=this.length-e;if((void 0===n||n>i)&&(n=i),t.length>0&&(n<0||e<0)||e>this.length)throw new RangeError("Attempt to write outside buffer bounds");r||(r="utf8");let s=!1;for(;;)switch(r){case"hex":return Qy(this,t,e,n);case"utf8":case"utf-8":return Jy(this,t,e,n);case"ascii":case"latin1":case"binary":return Xy(this,t,e,n);case"base64":return Yy(this,t,e,n);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Zy(this,t,e,n);default:if(s)throw new TypeError("Unknown encoding: "+r);r=(""+r).toLowerCase(),s=!0}},Uy.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function nv(t,e,n){let r="";n=Math.min(t.length,n);for(let i=e;i<n;++i)r+=String.fromCharCode(127&t[i]);return r}function rv(t,e,n){let r="";n=Math.min(t.length,n);for(let i=e;i<n;++i)r+=String.fromCharCode(t[i]);return r}function iv(t,e,n){const r=t.length;(!e||e<0)&&(e=0),(!n||n<0||n>r)&&(n=r);let i="";for(let r=e;r<n;++r)i+=Sv[t[r]];return i}function sv(t,e,n){const r=t.slice(e,n);let i="";for(let t=0;t<r.length-1;t+=2)i+=String.fromCharCode(r[t]+256*r[t+1]);return i}function ov(t,e,n){if(t%1!=0||t<0)throw new RangeError("offset is not uint");if(t+e>n)throw new RangeError("Trying to access beyond buffer length")}function av(t,e,n,r,i,s){if(!Uy.isBuffer(t))throw new TypeError('"buffer" argument must be a Buffer instance');if(e>i||e<s)throw new RangeError('"value" argument is out of bounds');if(n+r>t.length)throw new RangeError("Index out of range")}function cv(t,e,n,r,i){mv(e,r,i,t,n,7);let s=Number(e&BigInt(4294967295));t[n++]=s,s>>=8,t[n++]=s,s>>=8,t[n++]=s,s>>=8,t[n++]=s;let o=Number(e>>BigInt(32)&BigInt(4294967295));return t[n++]=o,o>>=8,t[n++]=o,o>>=8,t[n++]=o,o>>=8,t[n++]=o,n}function uv(t,e,n,r,i){mv(e,r,i,t,n,7);let s=Number(e&BigInt(4294967295));t[n+7]=s,s>>=8,t[n+6]=s,s>>=8,t[n+5]=s,s>>=8,t[n+4]=s;let o=Number(e>>BigInt(32)&BigInt(4294967295));return t[n+3]=o,o>>=8,t[n+2]=o,o>>=8,t[n+1]=o,o>>=8,t[n]=o,n+8}function lv(t,e,n,r,i,s){if(n+r>t.length)throw new RangeError("Index out of range");if(n<0)throw new RangeError("Index out of range")}function hv(t,e,n,r,i){return e=+e,n>>>=0,i||lv(t,0,n,4),Cy(t,e,n,r,23,4),n+4}function dv(t,e,n,r,i){return e=+e,n>>>=0,i||lv(t,0,n,8),Cy(t,e,n,r,52,8),n+8}Uy.prototype.slice=function(t,e){const n=this.length;(t=~~t)<0?(t+=n)<0&&(t=0):t>n&&(t=n),(e=void 0===e?n:~~e)<0?(e+=n)<0&&(e=0):e>n&&(e=n),e<t&&(e=t);const r=this.subarray(t,e);return Object.setPrototypeOf(r,Uy.prototype),r},Uy.prototype.readUintLE=Uy.prototype.readUIntLE=function(t,e,n){t>>>=0,e>>>=0,n||ov(t,e,this.length);let r=this[t],i=1,s=0;for(;++s<e&&(i*=256);)r+=this[t+s]*i;return r},Uy.prototype.readUintBE=Uy.prototype.readUIntBE=function(t,e,n){t>>>=0,e>>>=0,n||ov(t,e,this.length);let r=this[t+--e],i=1;for(;e>0&&(i*=256);)r+=this[t+--e]*i;return r},Uy.prototype.readUint8=Uy.prototype.readUInt8=function(t,e){return t>>>=0,e||ov(t,1,this.length),this[t]},Uy.prototype.readUint16LE=Uy.prototype.readUInt16LE=function(t,e){return t>>>=0,e||ov(t,2,this.length),this[t]|this[t+1]<<8},Uy.prototype.readUint16BE=Uy.prototype.readUInt16BE=function(t,e){return t>>>=0,e||ov(t,2,this.length),this[t]<<8|this[t+1]},Uy.prototype.readUint32LE=Uy.prototype.readUInt32LE=function(t,e){return t>>>=0,e||ov(t,4,this.length),(this[t]|this[t+1]<<8|this[t+2]<<16)+16777216*this[t+3]},Uy.prototype.readUint32BE=Uy.prototype.readUInt32BE=function(t,e){return t>>>=0,e||ov(t,4,this.length),16777216*this[t]+(this[t+1]<<16|this[t+2]<<8|this[t+3])},Uy.prototype.readBigUInt64LE=Cv((function(t){yv(t>>>=0,"offset");const e=this[t],n=this[t+7];void 0!==e&&void 0!==n||vv(t,this.length-8);const r=e+256*this[++t]+65536*this[++t]+this[++t]*2**24,i=this[++t]+256*this[++t]+65536*this[++t]+n*2**24;return BigInt(r)+(BigInt(i)<<BigInt(32))})),Uy.prototype.readBigUInt64BE=Cv((function(t){yv(t>>>=0,"offset");const e=this[t],n=this[t+7];void 0!==e&&void 0!==n||vv(t,this.length-8);const r=e*2**24+65536*this[++t]+256*this[++t]+this[++t],i=this[++t]*2**24+65536*this[++t]+256*this[++t]+n;return(BigInt(r)<<BigInt(32))+BigInt(i)})),Uy.prototype.readIntLE=function(t,e,n){t>>>=0,e>>>=0,n||ov(t,e,this.length);let r=this[t],i=1,s=0;for(;++s<e&&(i*=256);)r+=this[t+s]*i;return i*=128,r>=i&&(r-=Math.pow(2,8*e)),r},Uy.prototype.readIntBE=function(t,e,n){t>>>=0,e>>>=0,n||ov(t,e,this.length);let r=e,i=1,s=this[t+--r];for(;r>0&&(i*=256);)s+=this[t+--r]*i;return i*=128,s>=i&&(s-=Math.pow(2,8*e)),s},Uy.prototype.readInt8=function(t,e){return t>>>=0,e||ov(t,1,this.length),128&this[t]?-1*(255-this[t]+1):this[t]},Uy.prototype.readInt16LE=function(t,e){t>>>=0,e||ov(t,2,this.length);const n=this[t]|this[t+1]<<8;return 32768&n?4294901760|n:n},Uy.prototype.readInt16BE=function(t,e){t>>>=0,e||ov(t,2,this.length);const n=this[t+1]|this[t]<<8;return 32768&n?4294901760|n:n},Uy.prototype.readInt32LE=function(t,e){return t>>>=0,e||ov(t,4,this.length),this[t]|this[t+1]<<8|this[t+2]<<16|this[t+3]<<24},Uy.prototype.readInt32BE=function(t,e){return t>>>=0,e||ov(t,4,this.length),this[t]<<24|this[t+1]<<16|this[t+2]<<8|this[t+3]},Uy.prototype.readBigInt64LE=Cv((function(t){yv(t>>>=0,"offset");const e=this[t],n=this[t+7];void 0!==e&&void 0!==n||vv(t,this.length-8);const r=this[t+4]+256*this[t+5]+65536*this[t+6]+(n<<24);return(BigInt(r)<<BigInt(32))+BigInt(e+256*this[++t]+65536*this[++t]+this[++t]*2**24)})),Uy.prototype.readBigInt64BE=Cv((function(t){yv(t>>>=0,"offset");const e=this[t],n=this[t+7];void 0!==e&&void 0!==n||vv(t,this.length-8);const r=(e<<24)+65536*this[++t]+256*this[++t]+this[++t];return(BigInt(r)<<BigInt(32))+BigInt(this[++t]*2**24+65536*this[++t]+256*this[++t]+n)})),Uy.prototype.readFloatLE=function(t,e){return t>>>=0,e||ov(t,4,this.length),Sy(this,t,!0,23,4)},Uy.prototype.readFloatBE=function(t,e){return t>>>=0,e||ov(t,4,this.length),Sy(this,t,!1,23,4)},Uy.prototype.readDoubleLE=function(t,e){return t>>>=0,e||ov(t,8,this.length),Sy(this,t,!0,52,8)},Uy.prototype.readDoubleBE=function(t,e){return t>>>=0,e||ov(t,8,this.length),Sy(this,t,!1,52,8)},Uy.prototype.writeUintLE=Uy.prototype.writeUIntLE=function(t,e,n,r){if(t=+t,e>>>=0,n>>>=0,!r){av(this,t,e,n,Math.pow(2,8*n)-1,0)}let i=1,s=0;for(this[e]=255&t;++s<n&&(i*=256);)this[e+s]=t/i&255;return e+n},Uy.prototype.writeUintBE=Uy.prototype.writeUIntBE=function(t,e,n,r){if(t=+t,e>>>=0,n>>>=0,!r){av(this,t,e,n,Math.pow(2,8*n)-1,0)}let i=n-1,s=1;for(this[e+i]=255&t;--i>=0&&(s*=256);)this[e+i]=t/s&255;return e+n},Uy.prototype.writeUint8=Uy.prototype.writeUInt8=function(t,e,n){return t=+t,e>>>=0,n||av(this,t,e,1,255,0),this[e]=255&t,e+1},Uy.prototype.writeUint16LE=Uy.prototype.writeUInt16LE=function(t,e,n){return t=+t,e>>>=0,n||av(this,t,e,2,65535,0),this[e]=255&t,this[e+1]=t>>>8,e+2},Uy.prototype.writeUint16BE=Uy.prototype.writeUInt16BE=function(t,e,n){return t=+t,e>>>=0,n||av(this,t,e,2,65535,0),this[e]=t>>>8,this[e+1]=255&t,e+2},Uy.prototype.writeUint32LE=Uy.prototype.writeUInt32LE=function(t,e,n){return t=+t,e>>>=0,n||av(this,t,e,4,4294967295,0),this[e+3]=t>>>24,this[e+2]=t>>>16,this[e+1]=t>>>8,this[e]=255&t,e+4},Uy.prototype.writeUint32BE=Uy.prototype.writeUInt32BE=function(t,e,n){return t=+t,e>>>=0,n||av(this,t,e,4,4294967295,0),this[e]=t>>>24,this[e+1]=t>>>16,this[e+2]=t>>>8,this[e+3]=255&t,e+4},Uy.prototype.writeBigUInt64LE=Cv((function(t,e=0){return cv(this,t,e,BigInt(0),BigInt("0xffffffffffffffff"))})),Uy.prototype.writeBigUInt64BE=Cv((function(t,e=0){return uv(this,t,e,BigInt(0),BigInt("0xffffffffffffffff"))})),Uy.prototype.writeIntLE=function(t,e,n,r){if(t=+t,e>>>=0,!r){const r=Math.pow(2,8*n-1);av(this,t,e,n,r-1,-r)}let i=0,s=1,o=0;for(this[e]=255&t;++i<n&&(s*=256);)t<0&&0===o&&0!==this[e+i-1]&&(o=1),this[e+i]=(t/s>>0)-o&255;return e+n},Uy.prototype.writeIntBE=function(t,e,n,r){if(t=+t,e>>>=0,!r){const r=Math.pow(2,8*n-1);av(this,t,e,n,r-1,-r)}let i=n-1,s=1,o=0;for(this[e+i]=255&t;--i>=0&&(s*=256);)t<0&&0===o&&0!==this[e+i+1]&&(o=1),this[e+i]=(t/s>>0)-o&255;return e+n},Uy.prototype.writeInt8=function(t,e,n){return t=+t,e>>>=0,n||av(this,t,e,1,127,-128),t<0&&(t=255+t+1),this[e]=255&t,e+1},Uy.prototype.writeInt16LE=function(t,e,n){return t=+t,e>>>=0,n||av(this,t,e,2,32767,-32768),this[e]=255&t,this[e+1]=t>>>8,e+2},Uy.prototype.writeInt16BE=function(t,e,n){return t=+t,e>>>=0,n||av(this,t,e,2,32767,-32768),this[e]=t>>>8,this[e+1]=255&t,e+2},Uy.prototype.writeInt32LE=function(t,e,n){return t=+t,e>>>=0,n||av(this,t,e,4,2147483647,-2147483648),this[e]=255&t,this[e+1]=t>>>8,this[e+2]=t>>>16,this[e+3]=t>>>24,e+4},Uy.prototype.writeInt32BE=function(t,e,n){return t=+t,e>>>=0,n||av(this,t,e,4,2147483647,-2147483648),t<0&&(t=4294967295+t+1),this[e]=t>>>24,this[e+1]=t>>>16,this[e+2]=t>>>8,this[e+3]=255&t,e+4},Uy.prototype.writeBigInt64LE=Cv((function(t,e=0){return cv(this,t,e,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))})),Uy.prototype.writeBigInt64BE=Cv((function(t,e=0){return uv(this,t,e,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))})),Uy.prototype.writeFloatLE=function(t,e,n){return hv(this,t,e,!0,n)},Uy.prototype.writeFloatBE=function(t,e,n){return hv(this,t,e,!1,n)},Uy.prototype.writeDoubleLE=function(t,e,n){return dv(this,t,e,!0,n)},Uy.prototype.writeDoubleBE=function(t,e,n){return dv(this,t,e,!1,n)},Uy.prototype.copy=function(t,e,n,r){if(!Uy.isBuffer(t))throw new TypeError("argument should be a Buffer");if(n||(n=0),r||0===r||(r=this.length),e>=t.length&&(e=t.length),e||(e=0),r>0&&r<n&&(r=n),r===n)return 0;if(0===t.length||0===this.length)return 0;if(e<0)throw new RangeError("targetStart out of bounds");if(n<0||n>=this.length)throw new RangeError("Index out of range");if(r<0)throw new RangeError("sourceEnd out of bounds");r>this.length&&(r=this.length),t.length-e<r-n&&(r=t.length-e+n);const i=r-n;return this===t&&"function"==typeof Uint8Array.prototype.copyWithin?this.copyWithin(e,n,r):Uint8Array.prototype.set.call(t,this.subarray(n,r),e),i},Uy.prototype.fill=function(t,e,n,r){if("string"==typeof t){if("string"==typeof e?(r=e,e=0,n=this.length):"string"==typeof n&&(r=n,n=this.length),void 0!==r&&"string"!=typeof r)throw new TypeError("encoding must be a string");if("string"==typeof r&&!Uy.isEncoding(r))throw new TypeError("Unknown encoding: "+r);if(1===t.length){const e=t.charCodeAt(0);("utf8"===r&&e<128||"latin1"===r)&&(t=e)}}else"number"==typeof t?t&=255:"boolean"==typeof t&&(t=Number(t));if(e<0||this.length<e||this.length<n)throw new RangeError("Out of range index");if(n<=e)return this;let i;if(e>>>=0,n=void 0===n?this.length:n>>>0,t||(t=0),"number"==typeof t)for(i=e;i<n;++i)this[i]=t;else{const s=Uy.isBuffer(t)?t:Uy.from(t,r),o=s.length;if(0===o)throw new TypeError('The value "'+t+'" is invalid for argument "value"');for(i=0;i<n-e;++i)this[i+e]=s[i%o]}return this};const fv={};function pv(t,e,n){fv[t]=class extends n{get code(){return t}set code(t){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:t,writable:!0})}toString(){return`${this.name} [${t}]: ${this.message}`}constructor(){super(),Object.defineProperty(this,"message",{value:e.apply(this,arguments),writable:!0,configurable:!0}),this.name=`${this.name} [${t}]`,this.stack,delete this.name}}}function gv(t){let e="",n=t.length;const r="-"===t[0]?1:0;for(;n>=r+4;n-=3)e=`_${t.slice(n-3,n)}${e}`;return`${t.slice(0,n)}${e}`}function mv(t,e,n,r,i,s){if(t>n||t<e){const r="bigint"==typeof e?"n":"";let i;throw i=s>3?0===e||e===BigInt(0)?`>= 0${r} and < 2${r} ** ${8*(s+1)}${r}`:`>= -(2${r} ** ${8*(s+1)-1}${r}) and < 2 ** ${8*(s+1)-1}${r}`:`>= ${e}${r} and <= ${n}${r}`,new fv.ERR_OUT_OF_RANGE("value",i,t)}!function(t,e,n){yv(e,"offset"),void 0!==t[e]&&void 0!==t[e+n]||vv(e,t.length-(n+1))}(r,i,s)}function yv(t,e){if("number"!=typeof t)throw new fv.ERR_INVALID_ARG_TYPE(e,"number",t)}function vv(t,e,n){if(Math.floor(t)!==t)throw yv(t,n),new fv.ERR_OUT_OF_RANGE(n||"offset","an integer",t);if(e<0)throw new fv.ERR_BUFFER_OUT_OF_BOUNDS;throw new fv.ERR_OUT_OF_RANGE(n||"offset",`>= ${n?1:0} and <= ${e}`,t)}pv("ERR_BUFFER_OUT_OF_BOUNDS",(function(t){return t?`${t} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"}),RangeError),pv("ERR_INVALID_ARG_TYPE",(function(t,e){return`The "${t}" argument must be of type number. Received type ${typeof e}`}),TypeError),pv("ERR_OUT_OF_RANGE",(function(t,e,n){let r=`The value of "${t}" is out of range.`,i=n;return Number.isInteger(n)&&Math.abs(n)>2**32?i=gv(String(n)):"bigint"==typeof n&&(i=String(n),(n>BigInt(2)**BigInt(32)||n<-(BigInt(2)**BigInt(32)))&&(i=gv(i)),i+="n"),r+=` It must be ${e}. Received ${i}`,r}),RangeError);const wv=/[^+/0-9A-Za-z-_]/g;function bv(t,e){let n;e=e||1/0;const r=t.length;let i=null;const s=[];for(let o=0;o<r;++o){if(n=t.charCodeAt(o),n>55295&&n<57344){if(!i){if(n>56319){(e-=3)>-1&&s.push(239,191,189);continue}if(o+1===r){(e-=3)>-1&&s.push(239,191,189);continue}i=n;continue}if(n<56320){(e-=3)>-1&&s.push(239,191,189),i=n;continue}n=65536+(i-55296<<10|n-56320)}else i&&(e-=3)>-1&&s.push(239,191,189);if(i=null,n<128){if((e-=1)<0)break;s.push(n)}else if(n<2048){if((e-=2)<0)break;s.push(n>>6|192,63&n|128)}else if(n<65536){if((e-=3)<0)break;s.push(n>>12|224,n>>6&63|128,63&n|128)}else{if(!(n<1114112))throw new Error("Invalid code point");if((e-=4)<0)break;s.push(n>>18|240,n>>12&63|128,n>>6&63|128,63&n|128)}}return s}function Ev(t){return Iy(function(t){if((t=(t=t.split("=")[0]).trim().replace(wv,"")).length<2)return"";for(;t.length%4!=0;)t+="=";return t}(t))}function Iv(t,e,n,r){let i;for(i=0;i<r&&!(i+n>=e.length||i>=t.length);++i)e[i+n]=t[i];return i}function Tv(t,e){return t instanceof e||null!=t&&null!=t.constructor&&null!=t.constructor.name&&t.constructor.name===e.name}function _v(t){return t!=t}const Sv=function(){const t="0123456789abcdef",e=new Array(256);for(let n=0;n<16;++n){const r=16*n;for(let i=0;i<16;++i)e[r+i]=t[n]+t[i]}return e}();function Cv(t){return"undefined"==typeof BigInt?Av:t}function Av(){throw new Error("BigInt not supported")}var kv=Ey;function Rv(t){return yy.isPlainObject(t)||yy.isArray(t)}function Nv(t){return yy.endsWith(t,"[]")?t.slice(0,-2):t}function Ov(t,e,n){return t?t.concat(e).map((function(t,e){return t=Nv(t),!n&&e?"["+t+"]":t})).join(n?".":""):e}const Dv=yy.toFlatObject(yy,{},null,(function(t){return/^is[A-Z]/.test(t)}));var Lv=function(t,e,n){if(!yy.isObject(t))throw new TypeError("target must be an object");e=e||new FormData;const r=(n=yy.toFlatObject(n,{metaTokens:!0,dots:!1,indexes:!1},!1,(function(t,e){return!yy.isUndefined(e[t])}))).metaTokens,i=n.visitor||u,s=n.dots,o=n.indexes,a=(n.Blob||"undefined"!=typeof Blob&&Blob)&&yy.isSpecCompliantForm(e);if(!yy.isFunction(i))throw new TypeError("visitor must be a function");function c(t){if(null===t)return"";if(yy.isDate(t))return t.toISOString();if(!a&&yy.isBlob(t))throw new _y("Blob is not supported. Use a Buffer instead.");return yy.isArrayBuffer(t)||yy.isTypedArray(t)?a&&"function"==typeof Blob?new Blob([t]):kv.from(t):t}function u(t,n,i){let a=t;if(t&&!i&&"object"==typeof t)if(yy.endsWith(n,"{}"))n=r?n:n.slice(0,-2),t=JSON.stringify(t);else if(yy.isArray(t)&&function(t){return yy.isArray(t)&&!t.some(Rv)}(t)||(yy.isFileList(t)||yy.endsWith(n,"[]"))&&(a=yy.toArray(t)))return n=Nv(n),a.forEach((function(t,r){!yy.isUndefined(t)&&null!==t&&e.append(!0===o?Ov([n],r,s):null===o?n:n+"[]",c(t))})),!1;return!!Rv(t)||(e.append(Ov(i,n,s),c(t)),!1)}const l=[],h=Object.assign(Dv,{defaultVisitor:u,convertValue:c,isVisitable:Rv});if(!yy.isObject(t))throw new TypeError("data must be an object");return function t(n,r){if(!yy.isUndefined(n)){if(-1!==l.indexOf(n))throw Error("Circular reference detected in "+r.join("."));l.push(n),yy.forEach(n,(function(n,s){!0===(!(yy.isUndefined(n)||null===n)&&i.call(e,n,yy.isString(s)?s.trim():s,r,h))&&t(n,r?r.concat(s):[s])})),l.pop()}}(t),e};function Pv(t){const e={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+","%00":"\0"};return encodeURIComponent(t).replace(/[!'()~]|%20|%00/g,(function(t){return e[t]}))}function xv(t,e){this._pairs=[],t&&Lv(t,this,e)}const Mv=xv.prototype;Mv.append=function(t,e){this._pairs.push([t,e])},Mv.toString=function(t){const e=t?function(e){return t.call(this,e,Pv)}:Pv;return this._pairs.map((function(t){return e(t[0])+"="+e(t[1])}),"").join("&")};var Uv=xv;function Fv(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function Bv(t,e,n){if(!e)return t;const r=n&&n.encode||Fv,i=n&&n.serialize;let s;if(s=i?i(e,n):yy.isURLSearchParams(e)?e.toString():new Uv(e,n).toString(r),s){const e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+s}return t}var Vv=class{use(t,e,n){return this.handlers.push({fulfilled:t,rejected:e,synchronous:!!n&&n.synchronous,runWhen:n?n.runWhen:null}),this.handlers.length-1}eject(t){this.handlers[t]&&(this.handlers[t]=null)}clear(){this.handlers&&(this.handlers=[])}forEach(t){yy.forEach(this.handlers,(function(e){null!==e&&t(e)}))}constructor(){this.handlers=[]}},jv={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1};var $v={isBrowser:!0,classes:{URLSearchParams:"undefined"!=typeof URLSearchParams?URLSearchParams:Uv,FormData:"undefined"!=typeof FormData?FormData:null,Blob:"undefined"!=typeof Blob?Blob:null},isStandardBrowserEnv:(()=>{let t;return("undefined"==typeof navigator||"ReactNative"!==(t=navigator.product)&&"NativeScript"!==t&&"NS"!==t)&&("undefined"!=typeof window&&"undefined"!=typeof document)})(),isStandardBrowserWebWorkerEnv:"undefined"!=typeof WorkerGlobalScope&&self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts,protocols:["http","https","file","blob","url","data"]};function qv(t,e){return Lv(t,new $v.classes.URLSearchParams,Object.assign({visitor:function(t,e,n,r){return $v.isNode&&yy.isBuffer(t)?(this.append(e,t.toString("base64")),!1):r.defaultVisitor.apply(this,arguments)}},e))}var zv=function(t){function e(t,n,r,i){let s=t[i++];const o=Number.isFinite(+s),a=i>=t.length;if(s=!s&&yy.isArray(r)?r.length:s,a)return yy.hasOwnProp(r,s)?r[s]=[r[s],n]:r[s]=n,!o;r[s]&&yy.isObject(r[s])||(r[s]=[]);return e(t,n,r[s],i)&&yy.isArray(r[s])&&(r[s]=function(t){const e={},n=Object.keys(t);let r;const i=n.length;let s;for(r=0;r<i;r++)s=n[r],e[s]=t[s];return e}(r[s])),!o}if(yy.isFormData(t)&&yy.isFunction(t.entries)){const n={};return yy.forEachEntry(t,((t,r)=>{e(function(t){return yy.matchAll(/\w+|\[(\w*)]/g,t).map((t=>"[]"===t[0]?"":t[1]||t[0]))}(t),r,n,0)})),n}return null};const Hv={"Content-Type":void 0};const Kv={transitional:jv,adapter:["xhr","http"],transformRequest:[function(t,e){const n=e.getContentType()||"",r=n.indexOf("application/json")>-1,i=yy.isObject(t);i&&yy.isHTMLForm(t)&&(t=new FormData(t));if(yy.isFormData(t))return r&&r?JSON.stringify(zv(t)):t;if(yy.isArrayBuffer(t)||yy.isBuffer(t)||yy.isStream(t)||yy.isFile(t)||yy.isBlob(t))return t;if(yy.isArrayBufferView(t))return t.buffer;if(yy.isURLSearchParams(t))return e.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),t.toString();let s;if(i){if(n.indexOf("application/x-www-form-urlencoded")>-1)return qv(t,this.formSerializer).toString();if((s=yy.isFileList(t))||n.indexOf("multipart/form-data")>-1){const e=this.env&&this.env.FormData;return Lv(s?{"files[]":t}:t,e&&new e,this.formSerializer)}}return i||r?(e.setContentType("application/json",!1),function(t,e,n){if(yy.isString(t))try{return(e||JSON.parse)(t),yy.trim(t)}catch(t){if("SyntaxError"!==t.name)throw t}return(n||JSON.stringify)(t)}(t)):t}],transformResponse:[function(t){const e=this.transitional||Kv.transitional,n=e&&e.forcedJSONParsing,r="json"===this.responseType;if(t&&yy.isString(t)&&(n&&!this.responseType||r)){const n=!(e&&e.silentJSONParsing)&&r;try{return JSON.parse(t)}catch(t){if(n){if("SyntaxError"===t.name)throw _y.from(t,_y.ERR_BAD_RESPONSE,this,null,this.response);throw t}}}return t}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:$v.classes.FormData,Blob:$v.classes.Blob},validateStatus:function(t){return t>=200&&t<300},headers:{common:{Accept:"application/json, text/plain, */*"}}};yy.forEach(["delete","get","head"],(function(t){Kv.headers[t]={}})),yy.forEach(["post","put","patch"],(function(t){Kv.headers[t]=yy.merge(Hv)}));var Gv=Kv;const Wv=yy.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var Qv=t=>{const e={};let n,r,i;return t&&t.split("\n").forEach((function(t){i=t.indexOf(":"),n=t.substring(0,i).trim().toLowerCase(),r=t.substring(i+1).trim(),!n||e[n]&&Wv[n]||("set-cookie"===n?e[n]?e[n].push(r):e[n]=[r]:e[n]=e[n]?e[n]+", "+r:r)})),e};const Jv=Symbol("internals");function Xv(t){return t&&String(t).trim().toLowerCase()}function Yv(t){return!1===t||null==t?t:yy.isArray(t)?t.map(Yv):String(t)}function Zv(t,e,n,r,i){return yy.isFunction(r)?r.call(this,e,n):(i&&(e=n),yy.isString(e)?yy.isString(r)?-1!==e.indexOf(r):yy.isRegExp(r)?r.test(e):void 0:void 0)}let tw=Symbol.iterator,ew=Symbol.toStringTag;class nw{set(t,e,n){const r=this;function i(t,e,n){const i=Xv(e);if(!i)throw new Error("header name must be a non-empty string");const s=yy.findKey(r,i);(!s||void 0===r[s]||!0===n||void 0===n&&!1!==r[s])&&(r[s||e]=Yv(t))}const s=(t,e)=>yy.forEach(t,((t,n)=>i(t,n,e)));return yy.isPlainObject(t)||t instanceof this.constructor?s(t,e):yy.isString(t)&&(t=t.trim())&&!/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim())?s(Qv(t),e):null!=t&&i(e,t,n),this}get(t,e){if(t=Xv(t)){const n=yy.findKey(this,t);if(n){const t=this[n];if(!e)return t;if(!0===e)return function(t){const e=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let r;for(;r=n.exec(t);)e[r[1]]=r[2];return e}(t);if(yy.isFunction(e))return e.call(this,t,n);if(yy.isRegExp(e))return e.exec(t);throw new TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=Xv(t)){const n=yy.findKey(this,t);return!(!n||void 0===this[n]||e&&!Zv(0,this[n],n,e))}return!1}delete(t,e){const n=this;let r=!1;function i(t){if(t=Xv(t)){const i=yy.findKey(n,t);!i||e&&!Zv(0,n[i],i,e)||(delete n[i],r=!0)}}return yy.isArray(t)?t.forEach(i):i(t),r}clear(t){const e=Object.keys(this);let n=e.length,r=!1;for(;n--;){const i=e[n];t&&!Zv(0,this[i],i,t,!0)||(delete this[i],r=!0)}return r}normalize(t){const e=this,n={};return yy.forEach(this,((r,i)=>{const s=yy.findKey(n,i);if(s)return e[s]=Yv(r),void delete e[i];const o=t?function(t){return t.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,((t,e,n)=>e.toUpperCase()+n))}(i):String(i).trim();o!==i&&delete e[i],e[o]=Yv(r),n[o]=!0})),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){const e=Object.create(null);return yy.forEach(this,((n,r)=>{null!=n&&!1!==n&&(e[r]=t&&yy.isArray(n)?n.join(", "):n)})),e}[tw](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map((([t,e])=>t+": "+e)).join("\n")}get[ew](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){const n=new this(t);return e.forEach((t=>n.set(t))),n}static accessor(t){const e=(this[Jv]=this[Jv]={accessors:{}}).accessors,n=this.prototype;function r(t){const r=Xv(t);e[r]||(!function(t,e){const n=yy.toCamelCase(" "+e);["get","set","has"].forEach((r=>{Object.defineProperty(t,r+n,{value:function(t,n,i){return this[r].call(this,e,t,n,i)},configurable:!0})}))}(n,t),e[r]=!0)}return yy.isArray(t)?t.forEach(r):r(t),this}constructor(t){t&&this.set(t)}}nw.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),yy.freezeMethods(nw.prototype),yy.freezeMethods(nw);var rw=nw;function iw(t,e){const n=this||Gv,r=e||n,i=rw.from(r.headers);let s=r.data;return yy.forEach(t,(function(t){s=t.call(n,s,i.normalize(),e?e.status:void 0)})),i.normalize(),s}function sw(t){return!(!t||!t.__CANCEL__)}function ow(t,e,n){_y.call(this,null==t?"canceled":t,_y.ERR_CANCELED,e,n),this.name="CanceledError"}yy.inherits(ow,_y,{__CANCEL__:!0});var aw=ow;function cw(t,e,n){const r=n.config.validateStatus;n.status&&r&&!r(n.status)?e(new _y("Request failed with status code "+n.status,[_y.ERR_BAD_REQUEST,_y.ERR_BAD_RESPONSE][Math.floor(n.status/100)-4],n.config,n.request,n)):t(n)}var uw=$v.isStandardBrowserEnv?{write:function(t,e,n,r,i,s){const o=[];o.push(t+"="+encodeURIComponent(e)),yy.isNumber(n)&&o.push("expires="+new Date(n).toGMTString()),yy.isString(r)&&o.push("path="+r),yy.isString(i)&&o.push("domain="+i),!0===s&&o.push("secure"),document.cookie=o.join("; ")},read:function(t){const e=document.cookie.match(new RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function lw(t,e){return e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t}function hw(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?lw(t,e):e}var dw=$v.isStandardBrowserEnv?function(){const t=/(msie|trident)/i.test(navigator.userAgent),e=document.createElement("a");let n;function r(n){let r=n;return t&&(e.setAttribute("href",r),r=e.href),e.setAttribute("href",r),{href:e.href,protocol:e.protocol?e.protocol.replace(/:$/,""):"",host:e.host,search:e.search?e.search.replace(/^\?/,""):"",hash:e.hash?e.hash.replace(/^#/,""):"",hostname:e.hostname,port:e.port,pathname:"/"===e.pathname.charAt(0)?e.pathname:"/"+e.pathname}}return n=r(window.location.href),function(t){const e=yy.isString(t)?r(t):t;return e.protocol===n.protocol&&e.host===n.host}}():function(){return!0};function fw(t){const e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}var pw=function(t,e){t=t||10;const n=new Array(t),r=new Array(t);let i,s=0,o=0;return e=void 0!==e?e:1e3,function(a){const c=Date.now(),u=r[o];i||(i=c),n[s]=a,r[s]=c;let l=o,h=0;for(;l!==s;)h+=n[l++],l%=t;if(s=(s+1)%t,s===o&&(o=(o+1)%t),c-i<e)return;const d=u&&c-u;return d?Math.round(1e3*h/d):void 0}};function gw(t,e){let n=0;const r=pw(50,250);return i=>{const s=i.loaded,o=i.lengthComputable?i.total:void 0,a=s-n,c=r(a);n=s;const u={loaded:s,total:o,progress:o?s/o:void 0,bytes:a,rate:c||void 0,estimated:c&&o&&s<=o?(o-s)/c:void 0,event:i};u[e?"download":"upload"]=!0,t(u)}}const mw={http:null,xhr:"undefined"!=typeof XMLHttpRequest&&function(t){return new Promise((function(e,n){let r=t.data;const i=rw.from(t.headers).normalize(),s=t.responseType;let o;function a(){t.cancelToken&&t.cancelToken.unsubscribe(o),t.signal&&t.signal.removeEventListener("abort",o)}yy.isFormData(r)&&($v.isStandardBrowserEnv||$v.isStandardBrowserWebWorkerEnv?i.setContentType(!1):i.setContentType("multipart/form-data;",!1));let c=new XMLHttpRequest;if(t.auth){const e=t.auth.username||"",n=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";i.set("Authorization","Basic "+btoa(e+":"+n))}const u=hw(t.baseURL,t.url);function l(){if(!c)return;const r=rw.from("getAllResponseHeaders"in c&&c.getAllResponseHeaders());cw((function(t){e(t),a()}),(function(t){n(t),a()}),{data:s&&"text"!==s&&"json"!==s?c.response:c.responseText,status:c.status,statusText:c.statusText,headers:r,config:t,request:c}),c=null}if(c.open(t.method.toUpperCase(),Bv(u,t.params,t.paramsSerializer),!0),c.timeout=t.timeout,"onloadend"in c?c.onloadend=l:c.onreadystatechange=function(){c&&4===c.readyState&&(0!==c.status||c.responseURL&&0===c.responseURL.indexOf("file:"))&&setTimeout(l)},c.onabort=function(){c&&(n(new _y("Request aborted",_y.ECONNABORTED,t,c)),c=null)},c.onerror=function(){n(new _y("Network Error",_y.ERR_NETWORK,t,c)),c=null},c.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded";const r=t.transitional||jv;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),n(new _y(e,r.clarifyTimeoutError?_y.ETIMEDOUT:_y.ECONNABORTED,t,c)),c=null},$v.isStandardBrowserEnv){const e=(t.withCredentials||dw(u))&&t.xsrfCookieName&&uw.read(t.xsrfCookieName);e&&i.set(t.xsrfHeaderName,e)}void 0===r&&i.setContentType(null),"setRequestHeader"in c&&yy.forEach(i.toJSON(),(function(t,e){c.setRequestHeader(e,t)})),yy.isUndefined(t.withCredentials)||(c.withCredentials=!!t.withCredentials),s&&"json"!==s&&(c.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&c.addEventListener("progress",gw(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&c.upload&&c.upload.addEventListener("progress",gw(t.onUploadProgress)),(t.cancelToken||t.signal)&&(o=e=>{c&&(n(!e||e.type?new aw(null,t,c):e),c.abort(),c=null)},t.cancelToken&&t.cancelToken.subscribe(o),t.signal&&(t.signal.aborted?o():t.signal.addEventListener("abort",o)));const h=fw(u);h&&-1===$v.protocols.indexOf(h)?n(new _y("Unsupported protocol "+h+":",_y.ERR_BAD_REQUEST,t)):c.send(r||null)}))}};yy.forEach(mw,((t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){}Object.defineProperty(t,"adapterName",{value:e})}}));var yw={getAdapter:t=>{t=yy.isArray(t)?t:[t];const{length:e}=t;let n,r;for(let i=0;i<e&&(n=t[i],!(r=yy.isString(n)?mw[n.toLowerCase()]:n));i++);if(!r){if(!1===r)throw new _y(`Adapter ${n} is not supported by the environment`,"ERR_NOT_SUPPORT");throw new Error(yy.hasOwnProp(mw,n)?`Adapter '${n}' is not available in the build`:`Unknown adapter '${n}'`)}if(!yy.isFunction(r))throw new TypeError("adapter is not a function");return r},adapters:mw};function vw(t){if(t.cancelToken&&t.cancelToken.throwIfRequested(),t.signal&&t.signal.aborted)throw new aw(null,t)}function ww(t){vw(t),t.headers=rw.from(t.headers),t.data=iw.call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);return yw.getAdapter(t.adapter||Gv.adapter)(t).then((function(e){return vw(t),e.data=iw.call(t,t.transformResponse,e),e.headers=rw.from(e.headers),e}),(function(e){return sw(e)||(vw(t),e&&e.response&&(e.response.data=iw.call(t,t.transformResponse,e.response),e.response.headers=rw.from(e.response.headers))),Promise.reject(e)}))}const bw=t=>t instanceof rw?t.toJSON():t;function Ew(t,e){e=e||{};const n={};function r(t,e,n){return yy.isPlainObject(t)&&yy.isPlainObject(e)?yy.merge.call({caseless:n},t,e):yy.isPlainObject(e)?yy.merge({},e):yy.isArray(e)?e.slice():e}function i(t,e,n){return yy.isUndefined(e)?yy.isUndefined(t)?void 0:r(void 0,t,n):r(t,e,n)}function s(t,e){if(!yy.isUndefined(e))return r(void 0,e)}function o(t,e){return yy.isUndefined(e)?yy.isUndefined(t)?void 0:r(void 0,t):r(void 0,e)}function a(n,i,s){return s in e?r(n,i):s in t?r(void 0,n):void 0}const c={url:s,method:s,data:s,baseURL:o,transformRequest:o,transformResponse:o,paramsSerializer:o,timeout:o,timeoutMessage:o,withCredentials:o,adapter:o,responseType:o,xsrfCookieName:o,xsrfHeaderName:o,onUploadProgress:o,onDownloadProgress:o,decompress:o,maxContentLength:o,maxBodyLength:o,beforeRedirect:o,transport:o,httpAgent:o,httpsAgent:o,cancelToken:o,socketPath:o,responseEncoding:o,validateStatus:a,headers:(t,e)=>i(bw(t),bw(e),!0)};return yy.forEach(Object.keys(Object.assign({},t,e)),(function(r){const s=c[r]||i,o=s(t[r],e[r],r);yy.isUndefined(o)&&s!==a||(n[r]=o)})),n}const Iw={};["object","boolean","number","function","string","symbol"].forEach(((t,e)=>{Iw[t]=function(n){return typeof n===t||"a"+(e<1?"n ":" ")+t}}));const Tw={};Iw.transitional=function(t,e,n){function r(t,e){return"[Axios v1.4.0] Transitional option '"+t+"'"+e+(n?". "+n:"")}return(n,i,s)=>{if(!1===t)throw new _y(r(i," has been removed"+(e?" in "+e:"")),_y.ERR_DEPRECATED);return e&&!Tw[i]&&(Tw[i]=!0,console.warn(r(i," has been deprecated since v"+e+" and will be removed in the near future"))),!t||t(n,i,s)}};var _w={assertOptions:function(t,e,n){if("object"!=typeof t)throw new _y("options must be an object",_y.ERR_BAD_OPTION_VALUE);const r=Object.keys(t);let i=r.length;for(;i-- >0;){const s=r[i],o=e[s];if(o){const e=t[s],n=void 0===e||o(e,s,t);if(!0!==n)throw new _y("option "+s+" must be "+n,_y.ERR_BAD_OPTION_VALUE)}else if(!0!==n)throw new _y("Unknown option "+s,_y.ERR_BAD_OPTION)}},validators:Iw};const Sw=_w.validators;class Cw{request(t,e){"string"==typeof t?(e=e||{}).url=t:e=t||{},e=Ew(this.defaults,e);const{transitional:n,paramsSerializer:r,headers:i}=e;let s;void 0!==n&&_w.assertOptions(n,{silentJSONParsing:Sw.transitional(Sw.boolean),forcedJSONParsing:Sw.transitional(Sw.boolean),clarifyTimeoutError:Sw.transitional(Sw.boolean)},!1),null!=r&&(yy.isFunction(r)?e.paramsSerializer={serialize:r}:_w.assertOptions(r,{encode:Sw.function,serialize:Sw.function},!0)),e.method=(e.method||this.defaults.method||"get").toLowerCase(),s=i&&yy.merge(i.common,i[e.method]),s&&yy.forEach(["delete","get","head","post","put","patch","common"],(t=>{delete i[t]})),e.headers=rw.concat(s,i);const o=[];let a=!0;this.interceptors.request.forEach((function(t){"function"==typeof t.runWhen&&!1===t.runWhen(e)||(a=a&&t.synchronous,o.unshift(t.fulfilled,t.rejected))}));const c=[];let u;this.interceptors.response.forEach((function(t){c.push(t.fulfilled,t.rejected)}));let l,h=0;if(!a){const t=[ww.bind(this),void 0];for(t.unshift.apply(t,o),t.push.apply(t,c),l=t.length,u=Promise.resolve(e);h<l;)u=u.then(t[h++],t[h++]);return u}l=o.length;let d=e;for(h=0;h<l;){const t=o[h++],e=o[h++];try{d=t(d)}catch(t){e.call(this,t);break}}try{u=ww.call(this,d)}catch(t){return Promise.reject(t)}for(h=0,l=c.length;h<l;)u=u.then(c[h++],c[h++]);return u}getUri(t){return Bv(hw((t=Ew(this.defaults,t)).baseURL,t.url),t.params,t.paramsSerializer)}constructor(t){this.defaults=t,this.interceptors={request:new Vv,response:new Vv}}}yy.forEach(["delete","get","head","options"],(function(t){Cw.prototype[t]=function(e,n){return this.request(Ew(n||{},{method:t,url:e,data:(n||{}).data}))}})),yy.forEach(["post","put","patch"],(function(t){function e(e){return function(n,r,i){return this.request(Ew(i||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:n,data:r}))}}Cw.prototype[t]=e(),Cw.prototype[t+"Form"]=e(!0)}));var Aw=Cw;class kw{throwIfRequested(){if(this.reason)throw this.reason}subscribe(t){this.reason?t(this.reason):this._listeners?this._listeners.push(t):this._listeners=[t]}unsubscribe(t){if(!this._listeners)return;const e=this._listeners.indexOf(t);-1!==e&&this._listeners.splice(e,1)}static source(){let t;return{token:new kw((function(e){t=e})),cancel:t}}constructor(t){if("function"!=typeof t)throw new TypeError("executor must be a function.");let e;this.promise=new Promise((function(t){e=t}));const n=this;this.promise.then((t=>{if(!n._listeners)return;let e=n._listeners.length;for(;e-- >0;)n._listeners[e](t);n._listeners=null})),this.promise.then=t=>{let e;const r=new Promise((t=>{n.subscribe(t),e=t})).then(t);return r.cancel=function(){n.unsubscribe(e)},r},t((function(t,r,i){n.reason||(n.reason=new aw(t,r,i),e(n.reason))}))}}var Rw=kw;const Nw={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(Nw).forEach((([t,e])=>{Nw[e]=t}));var Ow=Nw;const Dw=function t(e){const n=new Aw(e),r=Bm(Aw.prototype.request,n);return yy.extend(r,Aw.prototype,n,{allOwnKeys:!0}),yy.extend(r,n,null,{allOwnKeys:!0}),r.create=function(n){return t(Ew(e,n))},r}(Gv);Dw.Axios=Aw,Dw.CanceledError=aw,Dw.CancelToken=Rw,Dw.isCancel=sw,Dw.VERSION="1.4.0",Dw.toFormData=Lv,Dw.AxiosError=_y,Dw.Cancel=Dw.CanceledError,Dw.all=function(t){return Promise.all(t)},Dw.spread=function(t){return function(e){return t.apply(null,e)}},Dw.isAxiosError=function(t){return yy.isObject(t)&&!0===t.isAxiosError},Dw.mergeConfig=Ew,Dw.AxiosHeaders=rw,Dw.formToJSON=t=>zv(yy.isHTMLForm(t)?new FormData(t):t),Dw.HttpStatusCode=Ow,Dw.default=Dw;var Lw=Dw;const{Axios:Pw,AxiosError:xw,CanceledError:Mw,isCancel:Uw,CancelToken:Fw,VERSION:Bw,all:Vw,Cancel:jw,isAxiosError:$w,spread:qw,toFormData:zw,AxiosHeaders:Hw,HttpStatusCode:Kw,formToJSON:Gw,mergeConfig:Ww}=Lw,Qw=(document.querySelector(".scrollbar"),document.querySelector(".aside-list"));Qw.addEventListener("wheel",(function(t){t.preventDefault();var e=t.deltaY||t.detail||t.wheelDelta;Qw.scrollTop+=e})),async function(){await Lw.get("https://books-backend.p.goit.global/books/category-list").then((t=>{console.log(t.data);let e=1;Qw.insertAdjacentHTML("afterbegin",`<li class="category-aside-list"><button type="button" id="${e}" class="aside-list-button selected-category">All categories</button></li>`);for(let n=0;n<t.data.length;n++)e+=1,Qw.insertAdjacentHTML("beforeend",`<li class="category-aside-list"><button type="button" id="btnAsideListId${e}" class="aside-list-button">${t.data[n].list_name}</button></li>`);!function(){const t=document.querySelectorAll(".aside-list-button");t.forEach((e=>{e.addEventListener("click",(function(){t.forEach((t=>{t.classList.remove("selected-category")})),Jw=this.textContent,this.classList.add("selected-category"),console.log(Jw)}))}))}()}))}();let Jw="All categories";async function Xw(){try{const t=(await Lw.get("https://books-backend.p.goit.global/books/top-books")).data,e=$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelector(".bookShell");return t.forEach((n=>{const r=function(t){const{list_name:e,books:n}=t,r=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("div");r.className="book",r.classList.add("card");const i=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("div");i.className="book__body";const s=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("h2");s.textContent=e,s.className="book__category",i.appendChild(s);const o=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("ul");o.className="book__list",Array.isArray(n)&&n.slice(0,5).forEach((t=>{const e=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("li");e.className="book__item",e.addEventListener("click",(()=>{console.log(`Book ${t.title} clicked`)}));const n=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("div");n.classList.add("book-image-container");const r=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("img");r.src=t.book_image,r.alt=t.title,r.loading="lazy",r.className="book__img",r.classList.add("js-gallery-image"),r.setAttribute("data-id",t._id),n.appendChild(r);const i=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("div");i.classList.add("quick-view"),i.textContent="QUICK VIEW",n.appendChild(i),e.appendChild(n);const s=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("p");s.textContent=t.title,s.className="book__title",t.title.length>15?s.textContent=t.title.substring(0,15)+"...":s.textContent=t.title,e.appendChild(s);const a=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("p");a.textContent=`${t.author}`,a.className="book__author",e.appendChild(a),o.appendChild(e)}));i.appendChild(o),r.appendChild(i);const a=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("button");return a.textContent="See more",a.addEventListener("click",(async()=>{const t=e;!function(){const t=$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelector(".bookShell");for(;t.firstChild;)t.removeChild(t.firstChild)}();try{await async function(t){const e=`https://books-backend.p.goit.global/books/category?category=${t}`;try{const t=(await Lw.get(e)).data,n=$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelector(".bookShell");if(n.classList.add("bookShell-category"),t.forEach((t=>{const{book_image:e,title:r,author:i}=t,s=function(t,e,n){const r=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("div");r.className="book",r.addEventListener("click",(()=>{console.log(`Book ${e} clicked`)}));const i=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("div");i.classList.add("book-image-container");const s=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("img");s.src=t,s.alt=e,s.loading="lazy",s.className="book__img",s.classList.add("js-gallery-image"),i.appendChild(s);const o=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("div");o.classList.add("quick-view"),o.textContent="QUICK VIEW",i.appendChild(o),r.appendChild(i);const a=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("p");a.textContent=e,a.className="book__title",e.length>15?a.textContent=e.substring(0,15)+"...":a.textContent=e;r.appendChild(a);const c=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("p");c.textContent=n,c.classList.add("book__author","author"),n.length>15?c.textContent=n.substring(0,15)+"...":c.textContent=n;return r.appendChild(c),r}(e,r,i);s&&n.appendChild(s)})),0===t.length){const t=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("div");t.textContent="No books found",t.style.textAlign="center",n.appendChild(t)}return t}catch(t){throw console.error(t),t}}(t)}catch(t){console.error(t)}Yw()})),a.className="book__button",r.appendChild(a),r}(n);if(r&&e.appendChild(r),0===t.length){const t=$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelector(".bookShell"),e=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("div");e.textContent="No books found",e.style.textAlign="center",t.appendChild(e)}})),t}catch(t){throw console.error(t),t}}function Yw(){const t=window.innerWidth,e=t<480?1:t<780?3:5;$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelectorAll(".book__body ul").forEach((t=>{const n=t.querySelectorAll("li");for(let t=0;t<n.length;t++)n[t].style.display=t<e?"block":"none"}))}window.addEventListener("resize",Yw),Yw(),$7a8fb0f659835779$export$5a7bfc01df82fcd1.addEventListener("DOMContentLoaded",(async()=>{const t=$7a8fb0f659835779$export$5a7bfc01df82fcd1.createElement("div");t.classList.add("bookShell"),$7a8fb0f659835779$export$5a7bfc01df82fcd1.body.appendChild(t),Yw();try{await Xw()}catch(t){console.error(t)}Yw()}));var Zw;Zw=new URL(s("kyEFX").resolve("jDPoR"),import.meta.url).toString();var tb;tb=new URL(s("kyEFX").resolve("6uEBG"),import.meta.url).toString();var eb;eb=new URL(s("kyEFX").resolve("k1r7D"),import.meta.url).toString();var nb;nb=new URL(s("kyEFX").resolve("fp3fh"),import.meta.url).toString();var rb;rb=new URL(s("kyEFX").resolve("gQHiG"),import.meta.url).toString();var ib;ib=new URL(s("kyEFX").resolve("6dHKE"),import.meta.url).toString();var sb;sb=new URL(s("kyEFX").resolve("4XQzn"),import.meta.url).toString();var ob;ob=new URL(s("kyEFX").resolve("6jpBN"),import.meta.url).toString();var ab;ab=new URL(s("kyEFX").resolve("5PSBZ"),import.meta.url).toString();const cb=[{title:"Save the Children",url:"https://www.savethechildren.net/what-we-do/emergencies/ukraine-crisis",img:n(Zw)},{title:"Project HOPE",url:"https://www.projecthope.org/country/ukraine/",img:n(tb)},{title:"UNITED24",url:"https://u24.gov.ua/uk",img:n(eb)},{title:"International Medical Corps",url:"https://internationalmedicalcorps.org/country/ukraine/",img:n(nb)},{title:"Medicins Sans Frontieres",url:"https://www.msf.org/ukraine",img:n(rb)},{title:"RAZOM",url:"https://www.razomforukraine.org/",img:n(ib)},{title:"Action against hunger",url:"https://www.actionagainsthunger.org/location/europe/ukraine/",img:n(sb)},{title:"World vision",url:"https://www.wvi.org/emergencies/ukraine",img:n(ob)},{title:"Serhiy Prytula Charity Foundation",url:"https://prytulafoundation.org/en",img:n(ab)}];console.log(cb);const ub=document.querySelector(".support__list");cb.map(((t,e)=>{!function({title:t,url:e,img:n},r){const i=r+1;ub.insertAdjacentHTML("beforeend",`<li class="support__item"><a href="${e}" class="support__link"><span class="support__number">${String(i).padStart(2,"0")}</span><img src="${n}" alt="${t}" class="support__img"></a></li>`)}(t,e)}));var lb,hb={fetchBookById:async function(t){return await fetch(`https://books-backend.p.goit.global/books//${t}`).then((t=>{if(!t.ok)throw new Error(t.statusText);return t.json()}))}};lb=new URL(s("kyEFX").resolve("fGJyr"),import.meta.url).toString();var db;db=new URL(s("kyEFX").resolve("1HTp7"),import.meta.url).toString();var fb;fb=new URL(s("kyEFX").resolve("aSJpf"),import.meta.url).toString();const pb={div:$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelector(".bookShell"),closeModalBtn:$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelector('[data-action="close-modal"]'),backdrop:$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelector(".js-backdrop"),bookCard:$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelector(".js-book-card"),shoppingListBtn:$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelector('[data-action="shopping-list-modal"]'),text:$7a8fb0f659835779$export$5a7bfc01df82fcd1.querySelector(".js-modal-text")};let gb={};const mb=localStorage.getItem("info-shopping-list");let yb=JSON.parse(mb)||[];function vb(){window.removeEventListener("keydown",wb),$7a8fb0f659835779$export$5a7bfc01df82fcd1.body.classList.remove("js-show-modal")}function wb(t){"Escape"===t.code&&vb()}function bb(t){const{book_image:e,author:r,title:i,description:s,buy_links:o,_id:a,list_name:c}=t;gb.bookId=a,gb.bookAuthor=r,gb.bookTitle=i,gb.bookDescription=s,gb.bookCategory=c,gb.bookImage=e,gb.bookAmazon=o[0].url,gb.bookOpenBook=o[1].url,gb.bookShop=o[4].url;const u=`<div class="img-thumb"><img class="book-image"" src="${e}" alt="${i}" loading="lazy" data-id="${a}"/>\n    </div>\n    <div class="book-description-thumb">\n    <p class="book-title">${i}</p>\n    <p class="book-author">${r}</p>\n    <p class="book-description">${s}</p>\n    <div class="book-links">\n    <a class="book-buy-url" href="${o[0].url}" target="_blank" rel="noreferrer noopener">\n    <img src="${n(lb)}" width="62px" height="19px"/>\n    </a>\n    <a class="book-buy-url" href="${o[1].url}" target="_blank" rel="noreferrer noopener">\n    <img src="${n(fb)}" width="33px" height="32px"/>\n    </a>\n    <a class="book-buy-url" href="${o[4].url}" target="_blank" rel="noreferrer noopener">\n    <img src="${n(db)}" width="38px" height="36px"/>\n    </a>\n    </div>\n    </div>`;pb.bookCard.innerHTML=u}pb.div.addEventListener("click",(function(t){t.preventDefault();if(!t.target.classList.contains("js-gallery-image"))return;const e=t.target.dataset.id;0!==yb.length&&yb.find((t=>t.bookId===e))?(pb.shoppingListBtn.textContent="remove from the shopping list",pb.shoppingListBtn.classList.add("modal__button-shopping-list--remove"),pb.text.classList.remove("visually-hidden")):(pb.shoppingListBtn.textContent="add to shopping list",pb.text.classList.add("visually-hidden"),pb.shoppingListBtn.classList.remove("modal__button-shopping-list--remove"));pb.bookCard.innerHTML="",hb.fetchBookById(e).then(bb).catch((t=>console.err("Ooops! Something went wrong!"))),window.addEventListener("keydown",wb),$7a8fb0f659835779$export$5a7bfc01df82fcd1.body.classList.add("js-show-modal")})),pb.closeModalBtn.addEventListener("click",vb),pb.backdrop.addEventListener("click",(function(t){t.currentTarget===t.target&&vb()})),pb.shoppingListBtn.addEventListener("click",(function(t){try{const t=yb.findIndex((t=>t.bookId===gb.bookId));-1!==t?(yb.splice(t,1),localStorage.removeItem("info-shopping-list"),localStorage.setItem("info-shopping-list",JSON.stringify(yb))):(yb.push({...gb}),localStorage.setItem("info-shopping-list",JSON.stringify(yb)))}catch{console.err("Ooops! Something went wrong!")}vb()}));
//# sourceMappingURL=index.af377d90.js.map
